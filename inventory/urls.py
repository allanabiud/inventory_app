...
urlpatterns = [
    ...
    path("items/import", views.import_items_view, name="import_items"),
    path(
        "items/download-template",
        views.generate_csv_template_view,
        name="generate_item_csv_template",
    ),
    path("items/add-item", views.add_item, name="add_item"),
    ...
    path("items/delete-all", views.delete_all_items, name="delete_all_items"),
    # Categories
    ...
    path("units/add-unit", views.add_unit, name="add_unit"),
    path("units/<int:pk>/edit", views.edit_unit, name="edit_unit"),
    path("units/<int:pk>", views.view_unit, name="view_unit"),
    path("units/<int:pk>/delete", views.delete_unit, name="delete_unit"),
    path("units/delete-all", views.delete_all_units, name="delete_all_units"),
    ...
    path(
        "adjustments/delete-all",
        views.delete_all_adjustments,
        name="delete_all_adjustments",
    ),
    # Stock Alerts
    path("stock-alerts", views.low_stock_view, name="stock_alerts"),
    path(
